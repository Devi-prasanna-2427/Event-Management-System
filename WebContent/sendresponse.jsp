...
try{
		...
		PreparedStatement pst=	 conn.prepareStatement("insert  into response(email,message) values (?,?)");
		 ...
		 pst.setString(2, message);
		   ...
		   if(i==1){
			out.println("<script>");
			out.println("alert('response sent Successfully');");
